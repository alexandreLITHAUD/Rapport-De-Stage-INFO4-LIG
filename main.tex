...
\begin{itemize}
\item
  \textbf{Mail} -\textgreater{} Conférences, informations, et
  communication
\item
  \textbf{Telegram} -\textgreater{} communication, aide Nix,
  NixOs-Compose
\item
  \textbf{Gitlab} -\textgreater{} issues, repo, README, Doc\newline
\end{itemize}
...
d'expériencer le travail en laboratoire. Ainsi que les spécialités du
